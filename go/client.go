// Package dndgenerator provides a Go client for the D&D Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/dndgenerator?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/dndgenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the D&D Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new D&D Generator API client.
...
// Execute makes a request to the D&D Generator API with typed parameters.
//
...
//   - count: integer - Number of items to generate [min: 1, max: 10]
