...
class dndgeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/dndgenerator');
        }
        ...
        this.validationRules = {"type":{"type":"string","required":false,"default":"all"},"count":{"type":"integer","required":false,"min":1,"max":10,"default":1}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/dndgenerator`);
        }
    }
...
module.exports = dndgeneratorWrapper;
