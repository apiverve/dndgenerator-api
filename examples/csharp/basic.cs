...
{
    class D&amp;DGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/dndgenerator";

        /// <summary>
        /// Make a GET request to the D&amp;D Generator API
        /// </summary>
        static async Task<JsonDocument> CallD&amp;DGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;type&quot;] &#x3D; &quot;character&quot;, [&quot;count&quot;] &#x3D; 1 };
        ...
        {
            Console.WriteLine("📤 Calling D&amp;D Generator API...\n");

            var result = await CallD&amp;DGeneratorAPI();
