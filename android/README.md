...
```gradle
dependencies {
    implementation 'com.github.apiverve:dndgenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.dndgenerator.D&DGeneratorAPIClient;
import com.apiverve.dndgenerator.APIResponse;
import com.apiverve.dndgenerator.APIException;

// Initialize the client
D&DGeneratorAPIClient client = new D&DGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/dndgenerator](https://docs.apiverve.com/ref/dndgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/dndgenerator](https://docs.apiverve.com/ref/dndgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/dndgenerator-api/issues)
