...
```gradle
dependencies {
    implementation 'com.github.apiverve:dndgenerator-api:1.1.14'
}
```
...
```java
import com.apiverve.dndgenerator.DDGeneratorAPIClient;
import com.apiverve.dndgenerator.APIResponse;
import com.apiverve.dndgenerator.APIException;

// Initialize the client
DDGeneratorAPIClient client = new DDGeneratorAPIClient("YOUR_API_KEY");
