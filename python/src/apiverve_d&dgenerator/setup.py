...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/dndgenerator',
        'Source': 'https://github.com/apiverve/dndgenerator-api',
        'Bug Tracker': 'https://github.com/apiverve/dndgenerator-api/issues'
    },
    classifiers=[
