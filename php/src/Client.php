...
namespace APIVerve\Dndgenerator;
...
/**
 * Client for the D&D Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/dndgenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/dndgenerator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DndgeneratorClient] {$message}\n";
        }
    }
}
